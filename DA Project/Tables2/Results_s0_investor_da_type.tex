...
\midrule \\[-1.8ex] 
 Carports/Garages/Sheds & -0.063^{***} & -0.049^{**} & 0.019 & 0.013 & 0.014 & 0.009 \\ 
  & (0.023) & (0.024) & (0.024) & (0.024) & (0.024) & (0.024) \\ 
  %& & & & & & \\ 
 Duplex & 0.139^{***} & 0.088^{***} & 0.066^{***} & 0.087^{***} & 0.080^{***} & 0.082^{***} \\ 
  & (0.014) & (0.014) & (0.017) & (0.017) & (0.017) & (0.017) \\ 
  %& & & & & & \\ 
 Extension/Alteration & 0.082^{***} & 0.048^{***} & 0.058^{***} & 0.053^{***} & 0.054^{***} & 0.054^{***} \\ 
  & (0.008) & (0.009) & (0.010) & (0.010) & (0.010) & (0.010) \\ 
  %& & & & & & \\ 
 House/Single Dwelling & -0.111^{***} & -0.158^{***} & -0.122^{***} & -0.109^{***} & -0.110^{***} & -0.113^{***} \\ 
  & (0.012) & (0.011) & (0.017) & (0.017) & (0.017) & (0.017) \\ 
  %& & & & & & \\ 
 Multiple DA & 0.022 & -0.027^{*} & 0.016 & 0.023 & 0.024 & 0.018 \\ 
...
Observations & \multicolumn{1}{c}{265,470} & \multicolumn{1}{c}{229,805} & \multicolumn{1}{c}{117,605} & \multicolumn{1}{c}{117,605} & \multicolumn{1}{c}{117,605} & \multicolumn{1}{c}{117,605} \\ 
Adjusted R$^{2}$ & \multicolumn{1}{c}{0.046} & \multicolumn{1}{c}{0.062} & \multicolumn{1}{c}{0.123} & \multicolumn{1}{c}{0.126} & \multicolumn{1}{c}{0.126} & \multicolumn{1}{c}{0.124} \\ 

%F Statistic & \multicolumn{1}{c}{518.052$^{***}$ (df = 25; 265444)} & \multicolumn{1}{c}{546.342$^{***}$ (df = 28; 229776)} & \multicolumn{1}{c}{533.669$^{***}$ (df = 31; 117573)} & \multicolumn{1}{c}{529.388$^{***}$ (df = 32; 117572)} & \multicolumn{1}{c}{514.377$^{***}$ (df = 33; 117571)} & \multicolumn{1}{c}{554.262$^{***}$ (df = 30; 117574)} \\ 

F Statistic & \multicolumn{1}{c}{518.052$^{***}$} & \multicolumn{1}{c}{546.342$^{***}$} & \multicolumn{1}{c}{533.669$^{***}$} & \multicolumn{1}{c}{529.388$^{***}$} & \multicolumn{1}{c}{514.377$^{***}$} & \multicolumn{1}{c}{554.262$^{***}$} \\ 

 & \multicolumn{1}{c}{(df = 25; 265444)} & \multicolumn{1}{c}{(df = 28; 229776)} & \multicolumn{1}{c}{(df = 31; 117573)} & \multicolumn{1}{c}{(df = 32; 117572)} & \multicolumn{1}{c}{(df = 33; 117571)} & \multicolumn{1}{c}{(df = 30; 117574)} \\ 
