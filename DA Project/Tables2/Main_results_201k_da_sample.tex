...
\midrule \\[-1.8ex] 
 ...
 Duplex & 0.148^{***} & 0.143^{***} & 0.074^{***} & 0.077^{***} & 0.078^{***} & 0.082^{***} &  &  \\ 
  ...
  %& & & & & & & & \\ 
 Extension/Alteration & -0.022^{***} & -0.039^{***} & -0.026^{***} & -0.027^{***} & -0.028^{***} & -0.029^{***} &  &  \\ 
  & (0.002) & (0.002) & (0.003) & (0.003) & (0.003) & (0.003) &  &  \\ 
  %& & & & & & & & \\ 
 House/Single Dwelling & -0.100^{***} & -0.122^{***} & -0.173^{***} & -0.169^{***} & -0.169^{***} & -0.170^{***} &  &  \\ 
...
Observations & \multicolumn{1}{c}{1,263,756} & \multicolumn{1}{c}{1,140,558} & \multicolumn{1}{c}{529,063} & \multicolumn{1}{c}{529,063} & \multicolumn{1}{c}{529,063} & \multicolumn{1}{c}{529,063} & \multicolumn{1}{c}{529,063} & \multicolumn{1}{c}{529,063} \\ 
Adjusted R$^{2}$ & \multicolumn{1}{c}{0.136} & \multicolumn{1}{c}{0.160} & \multicolumn{1}{c}{0.281} & \multicolumn{1}{c}{0.289} & \multicolumn{1}{c}{0.289} & \multicolumn{1}{c}{0.287} & \multicolumn{1}{c}{0.287} & \multicolumn{1}{c}{0.285} \\ 
%F Statistic & \multicolumn{1}{c}{7,949.399$^{***}$ (df = 25; 1263730)} & \multicolumn{1}{c}{7,735.062$^{***}$ (df = 28; 1140529)} & \multicolumn{1}{c}{6,677.688$^{***}$ (df = 31; 529031)} & \multicolumn{1}{c}{6,718.845$^{***}$ (df = 32; 529030)} & \multicolumn{1}{c}{6,529.027$^{***}$ (df = 33; 529029)} & \multicolumn{1}{c}{7,108.311$^{***}$ (df = 30; 529032)} & \multicolumn{1}{c}{7,900.302$^{***}$ (df = 27; 529035)} & \multicolumn{1}{c}{8,797.499$^{***}$ (df = 24; 529038)} \\ 

F Statistic & \multicolumn{1}{c}{7,949.399$^{***}$} & \multicolumn{1}{c}{7,735.062$^{***}$} & \multicolumn{1}{c}{6,677.688$^{***}$} & \multicolumn{1}{c}{6,718.845$^{***}$} & \multicolumn{1}{c}{6,529.027$^{***}$} & \multicolumn{1}{c}{7,108.311$^{***}$} & \multicolumn{1}{c}{7,900.302$^{***}$} & \multicolumn{1}{c}{8,797.499$^{***}$} \\ 

 & \multicolumn{1}{c}{(df = 25; 1263730)} & \multicolumn{1}{c}{(df = 28; 1140529)} & \multicolumn{1}{c}{(df = 31; 529031)} & \multicolumn{1}{c}{(df = 32; 529030)} & \multicolumn{1}{c}{(df = 33; 529029)} & \multicolumn{1}{c}{(df = 30; 529032)} & \multicolumn{1}{c}{(df = 27; 529035)} & \multicolumn{1}{c}{(df = 24; 529038)} \\ 
