...
\midrule \\[-1.8ex] 
 ...
 Carports/Garages/Sheds & -0.090^{***} & -0.090^{***} & -0.022^{***} & -0.021^{***} & -0.021^{***} & -0.025^{***} &  &  \\ 
  ...
  %& & & & & & & & \\ 
 Duplex & 0.181^{***} & 0.135^{***} & 0.094^{***} & 0.097^{***} & 0.098^{***} & 0.101^{***} &  &  \\ 
  & (0.012) & (0.012) & (0.013) & (0.013) & (0.013) & (0.013) &  &  \\ 
  %& & & & & & & & \\ 
 Extension/Alteration & 0.028^{***} & -0.014^{***} & 0.001 & 0.001 & 0.000 & -0.001 &  &  \\ 
  & (0.003) & (0.003) & (0.004) & (0.004) & (0.004) & (0.004) &  &  \\ 
  %& & & & & & & & \\ 
 House/Single Dwelling & -0.080^{***} & -0.129^{***} & -0.105^{***} & -0.101^{***} & -0.100^{***} & -0.102^{***} &  &  \\ 
...
Adjusted R$^{2}$ & \multicolumn{1}{c}{0.125} & \multicolumn{1}{c}{0.149} & \multicolumn{1}{c}{0.281} & \multicolumn{1}{c}{0.289} & \multicolumn{1}{c}{0.290} & \multicolumn{1}{c}{0.287} & \multicolumn{1}{c}{0.289} & \multicolumn{1}{c}{0.287} \\ 
%F Statistic & \multicolumn{1}{c}{6,390.998$^{***}$ (df = 25; 1119267)} & \multicolumn{1}{c}{6,325.029$^{***}$ (df = 28; 1012407)} & \multicolumn{1}{c}{6,528.365$^{***}$ (df = 31; 516979)} & \multicolumn{1}{c}{6,580.655$^{***}$ (df = 32; 516978)} & \multicolumn{1}{c}{6,398.490$^{***}$ (df = 33; 516977)} & \multicolumn{1}{c}{6,954.690$^{***}$ (df = 30; 516980)} & \multicolumn{1}{c}{7,793.277$^{***}$ (df = 27; 516983)} & \multicolumn{1}{c}{8,663.804$^{***}$ (df = 24; 516986)} \\ 


F Statistic & \multicolumn{1}{c}{6,390.998$^{***}$} & \multicolumn{1}{c}{6,325.029$^{***}$} & \multicolumn{1}{c}{6,528.365$^{***}$} & \multicolumn{1}{c}{6,580.655$^{***}$} & \multicolumn{1}{c}{6,398.490$^{***}$} & \multicolumn{1}{c}{6,954.690$^{***}$} & \multicolumn{1}{c}{7,793.277$^{***}$} & \multicolumn{1}{c}{8,663.804$^{***}$} \\ 

 & \multicolumn{1}{c}{(df = 25; 1119267)} & \multicolumn{1}{c}{(df = 28; 1012407)} & \multicolumn{1}{c}{(df = 31; 516979)} & \multicolumn{1}{c}{(df = 32; 516978)} & \multicolumn{1}{c}{(df = 33; 516977)} & \multicolumn{1}{c}{(df = 30; 516980)} & \multicolumn{1}{c}{(df = 27; 516983)} & \multicolumn{1}{c}{(df = 24; 516986)} \\ 
